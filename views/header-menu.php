...
<div class="container">
    <div class="row header-menu">
        <div class="col-md-12">
            <strong><?php echo ($user->isloggedin()) ? $userID[0]->name : ''; ?></strong>
            <div class="bt-display">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                        <?php echo ($user->isloggedin()) ? '<a class="dropdown-item" href="home">Home</a>' : ''; ?>
                        <?php echo ($user->isloggedin()) ? '<a class="dropdown-item" href="update">Profile</a>' : '<a class="dropdown-item" href="login">Login</a>' ; ?>
                        <?php echo ($user->isloggedin()) ? '' : '<a class="dropdown-item" href="register">Register</a>'; ?>
